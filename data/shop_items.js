...
module.exports = [
  ...
  },
  {
    ...
    levelRequired: 2,
    price: 48,
    description: '小小的发酵桶，摆在角落里却很专业。佩戴后酿酒时间会略微缩短。',
    buyLine: '酒狐悄悄话: 这个小桶桶...看起来就很会酿酒！主人是想让我早点把酒酿好给你喝吗？',
    equipLine: '酒狐悄悄话: 迷你发酵桶就位~酒狐会更认真盯着酒香发出来的！',
    effectText: '（迷你发酵桶里传来细小的咕嘟声~）',
    bonus: { type: 'brew_time_reduction', value: 0.12 },
  },
  ...
  },
  {
    ...
    levelRequired: 4,
    price: 180,
    description: '薄薄的斗篷像夜风一样轻。佩戴后群聊关键词被动冒泡更容易触发。',
    buyLine: '酒狐悄悄话: 斗篷好轻...像夜里的风一样。主人，这是给酒狐的“巡逻装备”吗？',
    equipLine: '酒狐悄悄话: 夜风斗篷披好了~群里的动静，酒狐会更快听见的。',
    effectText: '（斗篷边缘轻轻摇晃，像夜风掠过~）',
    bonus: { type: 'passive_chance_bonus', value: 0.06 },
  },
  {
    id: 'tail_bell_strap',
    name: '尾铃束带',
    ...
    levelRequired: 4,
    price: 205,
    description: '系在尾巴上的细小铃铛，叮铃声会让酒狐更愿意被戳一戳和冒泡。被动触发的好感会更多一点。',
    buyLine: '酒狐悄悄话: 铃铛系在尾巴上...会一直响的啦！不过、不过听起来也挺可爱的...',
    equipLine: '酒狐悄悄话: 尾铃束带系好啦~叮铃♪ 主人戳一戳的时候，酒狐会更开心地回应~',
    effectText: '（尾铃叮铃作响，像在撒娇一样~）',
    bonus: { type: 'passive_affinity_bonus', value: 2 },
  },
  ...
  },
  {
    ...
    levelRequired: 6,
    price: 330,
    description: '带着麦芽与果香的小围裙，穿上后酒狐酿酒更容易出高品质。',
    buyLine: '酒狐悄悄话: 围裙上有好香的味道...像刚开瓶的果酒！主人好会挑~',
    equipLine: '酒狐悄悄话: 酿香围裙系好了~这次酿出来的酒，一定会更好喝的！',
    effectText: '（围裙上沾着淡淡的甜香，像把酒香也系在身上~）',
    bonus: { type: 'brew_quality_bonus', value: 0.2 },
  },
  {
    id: 'moon_necklace',
    name: '月光项链',
  ...
  },
  {
    ...
    levelRequired: 6,
    price: 360,
    description: '像把一小片星光挂在耳边。佩戴后稀有语录掉落概率会更高一点。',
    buyLine: '酒狐悄悄话: 耳坠里有星星在闪...主人，这是想让我多说一些特别珍贵的话吗？',
    equipLine: '酒狐悄悄话: 星辉耳坠戴好啦~酒狐会更容易想起那些只想悄悄告诉主人的小秘密。',
    effectText: '（耳坠像星光一样轻轻闪烁~）',
    bonus: { type: 'rare_chance_bonus', value: 0.04 },
  },
  {
    id: 'sunrise_charm',
    name: '晨光护符',
  ...
  },
  {
    ...
    levelRequired: 8,
    price: 820,
    description: '灯里像装着细碎星砂，轻轻晃动就会亮起来。佩戴后群聊关键词被动冒泡更容易触发。',
    buyLine: '酒狐悄悄话: 灯里有好多小小的星砂...晃一下就会亮！主人也太会挑礼物了吧！',
    equipLine: '酒狐悄悄话: 星砂灯点亮啦~群里只要出现有趣的话题，酒狐就更容易冒泡回应主人！',
    effectText: '（星砂灯里有细碎的光在流动~）',
    bonus: { type: 'passive_chance_bonus', value: 0.12 },
  },
  {
    id: 'starcloak',
    name: '星光披风',
  ...
  },
  {
    ...
    levelRequired: 2,
    price: 13,
    description: '甜甜的蜂蜜牛奶，喝下去就像把暖意含在嘴里。（心情→开心）',
    buyLine: '酒狐悄悄话: 蜂蜜牛奶~闻起来就好甜！主人也会陪我一起喝吗？',
    useLine: '酒狐悄悄话: 咕嘟...甜甜的、暖暖的...酒狐突然好想笑出来。(心情->开心)',
    effect: 'mood_happy',
  },
  {
    id: 'firework',
  ...
  },
  {
    ...
    levelRequired: 4,
    price: 32,
    description: '带着青草甜味的四叶草糖。使用后下一次签到的狐狐券奖励将翻倍。',
    buyLine: '酒狐悄悄话: 四叶草...是不是代表好运？主人把好运也分给酒狐了吗？',
    useLine: '酒狐悄悄话: 甜甜的草香在嘴里散开了...下一次签到时，酒狐会把更多奖励塞给主人！',
    effect: 'double_checkin',
  },
  {
    id: 'sake_premium',
  ...
  },
  {
    ...
    levelRequired: 6,
    price: 78,
    description: '一口下去像把时间拧紧。使用后正在酿造的酒会立刻完成。',
    buyLine: '酒狐悄悄话: 这瓶酒...闻起来有点不对劲。像把时间都泡进去了似的。',
    useLine: '酒狐悄悄话: 呼...时间好像“咔哒”一下停住了。酒香一下子就涌出来了！',
    effect: 'time_reverse',
  },
  {
    id: 'teleport_pearl',
  ...
  },
  {
    ...
    levelRequired: 8,
    price: 145,
    description: '一本写着细小星光字迹的手札，翻开就像听见一段稀有而珍贵的悄悄话。',
    buyLine: '酒狐悄悄话: 手札的纸页在发光...像是把星星写进去了。主人要和酒狐一起读吗？',
    useLine: '酒狐悄悄话: 翻开的瞬间，星光像风一样吹过来...酒狐想起了一段只想悄悄告诉主人的话。',
    effect: 'random_rare',
  },
  {
    id: 'aurora_omamori',
    ...
    levelRequired: 8,
    price: 128,
    description: '把极光的好运封在御守里。使用后下一次互动必定触发稀有语录。',
    buyLine: '酒狐悄悄话: 御守里有一抹像极光一样的颜色...主人是想把好运都给我吗？',
    useLine: '酒狐悄悄话: 御守发热了...像有好运在尾巴尖上绕圈。下一次互动时，酒狐一定会想起特别珍贵的话。',
    effect: 'guaranteed_rare',
  },
  {
    id: 'ancient_scroll',
    ...
    levelRequired: 8,
    price: 138,
    description: '卷轴上的符号像会自己移动。使用后会随机推进一项成就进度。',
    buyLine: '酒狐悄悄话: 这张卷轴...上面的符号像在动。主人确定要让我打开吗？',
    useLine: '酒狐悄悄话: 符号像星砂一样散开了...酒狐好像突然想起了一些以前没注意到的目标。',
    effect: 'mystery_potion',
  },
]
